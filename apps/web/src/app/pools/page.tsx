        ...
        <div className="lg:order-1 lg:col-span-2 bg-white rounded-xl shadow-sm p-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-gray-100 rounded-lg overflow-hidden">
            <div className="bg-white px-4 py-4">
              ...
              <p className="text-2xl font-bold tabular-nums leading-none text-gray-900">{stats.totalPools}</p>
            </div>
            <div className="bg-white px-4 py-4">
              <div className="flex items-center gap-1.5 mb-1.5">
                <MapPin className="h-3.5 w-3.5 text-blue-400" />
                <span className="text-[11px] font-medium text-gray-500 uppercase tracking-wide truncate">With Location</span>
              </div>
              <p className="text-2xl font-bold tabular-nums leading-none text-blue-600">{stats.poolsWithLocation}</p>
            </div>
            <div className="bg-white px-4 py-4">
              <div className="flex items-center gap-1.5 mb-1.5">
                <Users className="h-3.5 w-3.5" style={{ color: 'var(--theme-color)' }} />
                <span className="text-[11px] font-medium text-gray-500 uppercase tracking-wide truncate">Unique Clients</span>
              </div>
              <p className="text-2xl font-bold tabular-nums leading-none" style={{ color: 'var(--theme-color)' }}>{stats.totalClients}</p>
            </div>
            <div className="bg-white px-4 py-4">
              <div className="flex items-center gap-1.5 mb-1.5">
                <Droplet className="h-3.5 w-3.5 text-green-400" />
                <span className="text-[11px] font-medium text-gray-500 uppercase tracking-wide truncate">Avg. Volume</span>
              </div>
              <p className="text-2xl font-bold tabular-nums leading-none text-green-600">{formatVolume(stats.averageVolume)}</p>
            </div>
          </div>
        </div>
      </div>
