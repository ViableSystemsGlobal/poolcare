      ...
      <div className="bg-white rounded-xl shadow-sm p-5">
        ...
        <div className="bg-white px-4 py-4">
          <div className="flex items-center gap-1.5 mb-1.5">
            ...
            <span className="text-[11px] font-medium text-gray-500 uppercase tracking-wide truncate">Total Suppliers</span>
          </div>
          <p className="text-2xl font-bold tabular-nums leading-none text-gray-900">{totalSuppliers}</p>
        </div>
        <div className="bg-white px-4 py-4">
          <div className="flex items-center gap-1.5 mb-1.5">
          ...
          <p className="text-2xl font-bold tabular-nums leading-none text-green-600">{activeSuppliers}</p>
        </div>
        <div className="bg-white px-4 py-4">
          <div className="flex items-center gap-1.5 mb-1.5">
          ...
          <p className="text-2xl font-bold tabular-nums leading-none text-gray-600">{inactiveSuppliers}</p>
        </div>
        </div>
      </div>
          ...
          {loading ? (
            ...
            <div className="flex items-center justify-between border-t px-4 py-3">
              <p className="text-sm text-gray-500">
                Showing {(page - 1) * PAGE_SIZE + 1} - {Math.min(page * PAGE_SIZE, filteredSuppliers.length)} of {filteredSuppliers.length} suppliers
              </p>
              <div className="flex items-center gap-2">
