...
export default function LoginScreen() {
  ...
  const activeColor = themeColor || BRAND_COLOR;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={styles.card}>
          ...
          {step === "phone" ? (
            <>
              ...
              <TouchableOpacity
                style={[styles.btn, { backgroundColor: activeColor }, loading && styles.btnDisabled]}
            ...
            <>
              ...
              >
                <Ionicons name="refresh" size={14} color={resendIn > 0 ? "#9ca3af" : activeColor} />
                <Text style={[styles.linkText, { color: resendIn > 0 ? "#9ca3af" : activeColor }]}>
                  {resending
                    ? "Sending new code..."
                    : resendIn > 0
              ...
              <TouchableOpacity style={styles.linkBtn} onPress={() => { setStep("phone"); setOtp(""); }}>
                <Ionicons name="arrow-back" size={14} color={activeColor} />
                <Text style={[styles.linkText, { color: activeColor }]}>Change number</Text>
              </TouchableOpacity>
            </>
          )}
        </View>
        ...
        <TouchableOpacity
          style={styles.guestShopBtn}
          onPress={() => router.replace("/poolshop")}
          activeOpacity={0.75}
        >
          <Ionicons name="storefront-outline" size={16} color="#ffffff" />
          <Text style={styles.guestShopText}>Browse pool shop as guest</Text>
